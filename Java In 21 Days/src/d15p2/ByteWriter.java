...
public class ByteWriter {
	...
	public static void main(String[] args) {
		...
		try {
			// Create a .gif file in the d15p2 package, which is in src folder.  
			FileOutputStream file = new FileOutputStream("src/d15p2/pic.gif");
			// Write down the bytes from data array.  
